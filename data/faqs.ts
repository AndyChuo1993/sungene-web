...
export const faqs: FAQItem[] = [
  ...
  // Service
  {
    ...
    answer: { zh: '若是外銷客戶開發服務，通常在專案啟動後 2 至 4 週內會開始累積穩定回覆與詢問，實際速度仍會受到產業與市場影響。若是外貿業務外包，通常第一週會先完成交接與流程設定，之後開始進入可追蹤的開發與跟進節奏。', en: 'For Export Lead Generation, you typically see stable replies and inquiry accumulation in 2–4 weeks depending on market and industry. For Export Sales Outsourcing, we usually complete handover and start a trackable outreach + follow-up workflow within the first week.' },
  },
  {
    category: 'service',
    question: { zh: '你們會簽署保密協議嗎？', en: 'Do you sign NDAs?' },
    answer: { zh: '會。我們重視客戶的商業機密，合作開始前可簽署保密協議，確保客戶資料、價格策略與技術文件受到妥善保護。', en: 'Yes, we value client confidentiality. We sign strict NDAs before starting to ensure your client data, pricing, and tech docs remain secure.' },
  },
  {
    category: 'service',
  ...
  // Process
  {
    ...
    answer: { zh: '通常流程為：先確認需求與目標市場，接著簽署合作文件與保密協議，再進行產品與資料交接、名單建立、流程設定，最後正式啟動並定期回報成效。', en: '1. Consultation & Market Goal 2. Contract & NDA 3. Product/Data Handover 4. System Setup & List Building 5. Launch 6. Regular Reporting.' },
  },
  {
    category: 'process',
  ...
  // Pricing
  {
    ...
    answer: { zh: '目前主要提供三種合作方式：名單專案、開發專案，以及外貿外包月費制。實際費用會依服務範圍、目標市場與執行深度而有所不同。', en: 'Three models: "List Purchase" per lead; "Project Outreach" per project; "Outsourcing" monthly retainer. See Pricing page for details.' },
  },
  {
    category: 'pricing',
    question: { zh: '是否有最低合作期限？', en: 'Minimum contract term?' },
    answer: { zh: '名單與主動開發通常可依專案規模安排為一次性或短期合作；若是外貿外包，通常會建議至少合作 6 個月，較能建立穩定的開發節奏與成果累積。', en: '"Lead Gen" and "Outreach" are one-time or short-term. "Outsourcing" recommends a 6-month minimum to build a stable sales funnel.' },
  },
]
