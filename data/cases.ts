...
const cn: Record<string, CaseContent> = {
  hardware: {
    ...
    result: '有效商机成长与市场拓展',
    highlights: [
      { num: '50-60', label: '有效商机' },
      { num: '3个月', label: '建立稳定来源' },
      { num: '10+', label: '进入报价阶段' },
    ],
    before: ['依赖旧客户', '缺乏外贸团队', '展会效果递减'],
    after: ['建立精准采购与决策人资料', '自动化开发信', '稳定商机来源'],
    sections: [
      ...
      { heading: '成果数据', items: ['3个月内累计获得 50-60 个有效商机', '多个询盘来自德国知名工具品牌', '超过 10 个潜在客户进入样品与报价阶段'] },
...
const en: Record<string, CaseContent> = {
  hardware: {
    ...
    cover: baseCovers.hardware,
    proofImages: [proofImages.chart],
    summary: 'Built targeted buyer-side decision-maker data and created multiple sales opportunities, successfully establishing multiple potential client connections.',
