    ...
    <>
      ...
      <header className="fixed top-0 z-50 w-full border-b border-gray-100 bg-white/95 shadow-sm backdrop-blur">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6">
          <Link href={`/${lang}`} className="flex items-center gap-3 font-bold text-black">
            <Image src="/logo/sungene.png" alt="SunGene Industrial IoT" width={32} height={32} className="h-8 w-auto" priority />
            <span className="flex flex-col leading-tight">
              <span className="text-lg tracking-tight text-blue-900">SunGene</span>
              <span className="text-[10px] font-medium uppercase tracking-[0.18em] text-gray-500">Industrial IoT</span>
            </span>
          </Link>
