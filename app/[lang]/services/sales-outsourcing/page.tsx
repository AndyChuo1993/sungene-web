                ...
                <div className="prose prose-lg text-gray-600 mb-12">
                    ...
                    <ul className="space-y-4 list-none pl-0">
                        <li className="flex items-start">
                            ...
                            <span>
                                <strong>{lang === 'zh' ? '詢盤快速回應與篩選' : 'Rapid Inquiry Response & Screening'}</strong>: 
                                {lang === 'zh' ? ' 24小時內回覆詢盤，過濾無效客戶，確保您的時間花在有價值的訂單上。' : ' Reply within 24h, filter junk leads, focus your time on valuable orders.'}
                            </span>
                        </li>
                        <li className="flex items-start">
                            <span className="text-indigo-600 font-bold mr-2">✓</span>
                            <span>
                                <strong>{lang === 'zh' ? '商務溝通與樣品跟進' : 'Communication & Sampling Follow-up'}</strong>: 
                                {lang === 'zh' ? ' 協助處理樣品寄送流程、規格確認與初步報價談判。' : ' Assist with sampling, spec confirmation, and initial price negotiation.'}
                            </span>
                        </li>
                        <li className="flex items-start">
                            <span className="text-indigo-600 font-bold mr-2">✓</span>
                            <span>
                                <strong>{lang === 'zh' ? '定期商務匯報' : 'Regular Reporting'}</strong>: 
                                {lang === 'zh' ? ' 每週提供詢盤進度表與市場反饋報告，讓您掌握第一手市場動態。' : ' Weekly progress reports and market feedback to keep you updated.'}
                            </span>
                        </li>
                    </ul>
                </div>
