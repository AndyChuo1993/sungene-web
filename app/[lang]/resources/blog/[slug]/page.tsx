...
export async function generateMetadata({ params }: { params: { lang: Lang; slug: string } }) {
  ...
  return {
    ...
    alternates: {
      canonical: `/${lang}/resources/blog/${slug}`,
      languages: {
        zh: `/zh/resources/blog/${slug}`,
        en: `/en/resources/blog/${slug}`,
      },
    },
...
export default function Page({ params }: { params: { lang: Lang; slug: string } }) {
  ...
  const url = `${baseUrl}/${lang}/resources/blog/${slug}`
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: lang === 'zh' ? '資源中心' : 'Resources', item: `${baseUrl}/${lang}/resources` },
            ...
            <section className="mt-12 mb-16">
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-2">
                {related.map(r => (
                  <Link
                    key={r.slug}
                    href={`/${lang}/resources/blog/${r.slug}`}
