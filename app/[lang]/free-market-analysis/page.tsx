...
export default function Page({ params }: { params: { lang: Lang } }) {
  ...
  const fields: FormField[] = [
    ...
    { name: 'market', label: lang === 'zh' ? '目前主要出口市場' : 'Current Markets', type: 'text', required: true },
    { name: 'targetCountry', label: lang === 'zh' ? '想開發的目標國家' : 'Target Countries', type: 'text', required: true },
    { name: 'monthlyGoal', label: lang === 'zh' ? '每月預估開發目標 (筆數)' : 'Monthly Lead Goal', type: 'text' },
    { name: 'hasSalesTeam', label: lang === 'zh' ? '是否有外貿業務團隊' : 'Do you have an export team?', type: 'text' },
