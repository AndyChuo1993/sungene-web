        ...
        <div className="mx-auto max-w-7xl px-6 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-gray-600">
                    {lang === 'zh' ? '先從成功案例了解我們怎麼做，再決定你需要買家開發、經銷商開發，還是外銷業務外包服務。' : 'Start with case studies to see how we work, then decide whether you need lead generation, distributor development, or export sales outsourcing.'}
                </p>
            </div>
